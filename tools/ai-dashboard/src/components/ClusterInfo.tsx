...
// AWS i4i.4xlarge single-node AI benchmark — dataloader + ONNX inference.
// Hardware specs for AI workload optimization.
...
const AI_STACK = [
  { label: "ONNX Runtime", value: "1.20.1" },
  { label: "PyTorch", value: "2.6.0 (baseline)" },
  { label: "Batch Size", value: "32-64" },
  { label: "Workers", value: "8-16 threads" },
] as const;
...
export function ClusterInfo() {
  return (
    <div
      ...
      style={{
        background: "color-mix(in srgb, var(--accent-purple) 5%, var(--bg-card))",
    ...
    >
      <span
        ...
        style={{ color: "var(--accent-purple)", fontSize: "9px" }}
      >
        Test Environment
      </span>
