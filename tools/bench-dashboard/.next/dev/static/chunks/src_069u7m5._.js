...
function useBenchWS(wsUrl) {
    ...
    const pendingTicksRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(new Map());
    ...
    const flushSecond = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBenchWS.useCallback[flushSecond]": (t)=>{
            const shardMap = pendingTicksRef.current.get(t);
            if (!shardMap) return;
            pendingTicksRef.current.delete(t);
            setState({
                "useBenchWS.useCallback[flushSecond]": (prev)=>{
                    const aggTps = [
                        ...shardMap.values()
                    ].reduce({
                        "useBenchWS.useCallback[flushSecond].aggTps": (s, v)=>s + v.tps
                    }["useBenchWS.useCallback[flushSecond].aggTps"], 0);
                    const aggCommitted = [
                        ...shardMap.values()
                    ].reduce({
                        "useBenchWS.useCallback[flushSecond].aggCommitted": (s, v)=>s + v.committed
                    }["useBenchWS.useCallback[flushSecond].aggCommitted"], 0);
                    const aggRejected = [
                        ...shardMap.values()
                    ].reduce({
                        "useBenchWS.useCallback[flushSecond].aggRejected": (s, v)=>s + v.rejected
                    }["useBenchWS.useCallback[flushSecond].aggRejected"], 0);
                    const avgP50 = [
                        ...shardMap.values()
                    ].reduce({
                        "useBenchWS.useCallback[flushSecond]": (s, v)=>s + v.p50_us
                    }["useBenchWS.useCallback[flushSecond]"], 0) / (shardMap.size || 1);
                    const avgP99 = [
                        ...shardMap.values()
                    ].reduce({
                        "useBenchWS.useCallback[flushSecond]": (s, v)=>s + v.p99_us
                    }["useBenchWS.useCallback[flushSecond]"], 0) / (shardMap.size || 1);
                    ...
                    const snapshot = {
                        ...
                        per_shard: [
                            ...
                            "useBenchWS.useCallback[flushSecond]": ([id, d])=>({
                                    shard_id: id,
                                    tps: d.tps
                                })
                        }["useBenchWS.useCallback[flushSecond]"]),
                    ...
                    return {
                        ...
                        total_committed: [
                            ...
                            "useBenchWS.useCallback[flushSecond]": (s, v)=>s + v.committed_total
                        }["useBenchWS.useCallback[flushSecond]"], 0),
                        total_rejected: [
                            ...newShards.values()
                        ].reduce({
                            "useBenchWS.useCallback[flushSecond]": (s, v)=>s + v.rejected_total
                        }["useBenchWS.useCallback[flushSecond]"], 0),
        ...
        "useBenchWS.useCallback[handleMessage]": (raw)=>{
            ...
            if (msg.type === "tick") {
                ...
                flushTimerRef.current = setTimeout({
                    "useBenchWS.useCallback[handleMessage]": ()=>flushSecond(t)
                }["useBenchWS.useCallback[handleMessage]"], 1200);
            }
        }
    }["useBenchWS.useCallback[handleMessage]"], [
        flushSecond
    ...
    const connect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBenchWS.useCallback[connect]": ()=>{
            ...
            wsRef.current = ws;
            ws.onopen = ({
                "useBenchWS.useCallback[connect]": ()=>setState({
                        "useBenchWS.useCallback[connect]": (p)=>({
                                ...p,
                                status: "connecting"
                            })
            ...
            ws.onclose = ({
                "useBenchWS.useCallback[connect]": ()=>{
                    if (!summaryReceivedRef.current) {
                        setState({
                            "useBenchWS.useCallback[connect]": (p)=>p.status === "running" ? {
                                    ...p,
                                    status: "error"
                                } : p
                        }["useBenchWS.useCallback[connect]"]);
...
_s(useBenchWS, "S7orePszYqwWK3C0Seql6sPc9No=");
...
function CustomTooltip({ active, payload, label }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            tps > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                style: {
                    color: "var(--text-muted)"
                },
                children: [
...
"[project]/src/components/FailoverPanel.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    const nodes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FailoverPanel.useMemo[nodes]": ()=>{
            ...
            return [
                ...
                "FailoverPanel.useMemo[nodes]": (id)=>({
                        id,
                        label: `Node ${id + 1}`,
                                ...
                                EDGES.map(([a, b])=>{
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("g", {
                                        children: [
                                            ...
                                            alive && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("circle", {
                                                r: "1.6",
                                ...
                                nodes.map((node)=>{
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("g", {
                                        children: [
                                            ...
                                            isDown ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("text", {
                                                x: pos.x,
                                                y: pos.y + 1.5,
                                                textAnchor: "middle",
                                                ...
                                                lineNumber: 280,
                                                columnNumber: 21
                                            }, this) : isRecovering ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("text", {
                                                x: pos.x,
                                                y: pos.y + 1.5,
                                                textAnchor: "middle",
                                                dominantBaseline: "middle",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    !isDown && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: failoverEvents.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    style: {
                                        color: "var(--text-dim)"
                                    },
                                    children: [
                                    ...
                                    lineNumber: 474,
                                    columnNumber: 15
                                }, this) : failoverEvents.slice(-40).map((e, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(FailoverPanel, "tdVOBvl2PIoxj2Tsg8HAA9fzk0M=");
_c = FailoverPanel;
var _c;
__turbopack_context__.k.register(_c, "FailoverPanel");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/ClusterInfo.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SPECS = [
    ...
    },
    {
        icon: "⇅",
        label: "Transfer",
        value: DROPLET.transfer
    },
    {
        icon: "$",
        label: "Cost",
        value: `${DROPLET.price} × ${NODE_COUNT} = $${56 * NODE_COUNT}/mo`
    }
];
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                ...
                fileName: "[project]/src/components/ClusterInfo.tsx",
                lineNumber: 34,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            SPECS.map(({ label, value })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_c = ClusterInfo;
var _c;
__turbopack_context__.k.register(_c, "ClusterInfo");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$FailoverPanel$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/FailoverPanel.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ClusterInfo$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ClusterInfo.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mt-3",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ClusterInfo$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClusterInfo"], {}, void 0, false, {
                            fileName: "[project]/src/app/page.tsx",
                            lineNumber: 57,
                            columnNumber: 11
                        }, this)
                    ...
                    perShard.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mt-5",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        style: {
                                                            background: state.elapsed_secs - s.last_tick_t < 3 ? "var(--accent-green)" : "var(--text-muted)"
                                                        }
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/page.tsx",
                                                        lineNumber: 98,
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: s.tps_history.map((v, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                ...
                                                                children: s.p99_us > 0 ? s.p99_us >= 1_000_000 ? `${(s.p99_us / 1_000_000).toFixed(2)}s` : s.p99_us >= 1_000 ? `${(s.p99_us / 1_000).toFixed(1)}ms` : `${s.p99_us}µs` : "—"
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/app/page.tsx",
                                                                lineNumber: 159,
                                                                columnNumber: 25
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$FailoverPanel$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FailoverPanel"], {
                                state: state,
...
_s(DashboardPage, "Ftywa+PdrXYNb6VWflB85Yfl+j0=", false, function() {
    return [
...
//# sourceMappingURL=src_069u7m5._.js.map